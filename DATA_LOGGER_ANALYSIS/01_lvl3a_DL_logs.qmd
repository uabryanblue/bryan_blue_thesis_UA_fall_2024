---
title: "Experiment Sensor Data Level 3a"
author: "Bryan Blue"
...
**The level "3a" experiment started on April 3, 2024.**  
The original experiment "3" did not work due to installation failure.

Data from the experimental aspirated temperature, humidity, and pressure sensor.

## Level 3a Installation
...
**The experiment started on April 3, 2024.**
...
ggsave(here("figures", "deltaT_lvl3_april_2024.jpg"), plot = last_plot(), width = 8, height = 6)

```

# Leaf Warming All Data

**The experiment did not start until April 3, 2024.**
